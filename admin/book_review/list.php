...
<?
	...
	$_s3='echo \'<img src="/images/avatar/\'.$l1->pic.\'small.jpg" style="width: 60px; height: 60px;">\'; ';
	a_list(
		$l1,
		'ID|Дата|Вопрос|Ответ|Автор|Аватар|Выводить',
		'id|::echo hrdate($l1->posted);|message|otvet|author|::'.$_s3.'|::'.$_s,
		'edit|delete'
	); 
?>
</form>